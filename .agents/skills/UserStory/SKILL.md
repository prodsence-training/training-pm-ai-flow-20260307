...
請使用上下文：product-context-example.md
...
- **完整說明**：詳見 `README.md`
- **產品上下文示例**：`examples/product-context-example.md`
- **Gem 系統提示詞**：`reference/gemini-gem-PM-3-userstory-prompts.md`
- **OST 參考輸出**：`reference/from-skills-step2-ost.md`
